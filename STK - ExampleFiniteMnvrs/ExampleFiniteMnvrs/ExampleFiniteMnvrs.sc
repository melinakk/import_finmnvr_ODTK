...
BEGIN Scenario
    Name		 ExampleFiniteMnvrs

    BEGIN Epoch

        Epoch		 9 Jul 2019 16:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 9 Jul 2019 16:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 9 Jul 2019 16:00:00.000000000
        Stop		 10 Jul 2019 16:00:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 9 Jul 2019 16:00:00.000000000
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            ...
            AGIViewer		 Yes
            Instance		 Satellite/RetroMnvrSat
            BEGIN TimeData
                BEGIN Section
                    SectionNumber		 1
                    SectionType		 4
...
"9 Jul 2019 16:00:00.000000000" "10 Jul 2019 06:20:20.542828021"
                        END Intervals
...
"1 Jul 2019 16:00:00.000000000" "1 Jul 2019 18:31:07.288721745"
                        END Intervals
            ...
            BEGIN PreDataList
                BEGIN PreData
                    ServiceName		 Ric
                    Data		 Satellite/ProMnvrSat_ODTK
                END PreData
            END PreDataList
            DisplayOnLoad		 No
            FrameType		 0
...
"1 Jul 2019 16:00:00.000000000" "1 Jul 2019 23:15:14.328467743"
                        END Intervals
            ...
            BEGIN PreDataList
                BEGIN PreData
                    ServiceName		 Ric
                    Data		 Satellite/RetroMnvrSat_ODTK
                END PreData
            END PreDataList
            DisplayOnLoad		 No
            FrameType		 0
...
"1 Jul 2019 16:00:00.000000000" "1 Jul 2019 23:15:14.328467743"
    ...
    BEGIN Extensions
        ...
        BEGIN ExportDataFile
            FileType		 Ephemeris
            Directory		 C:\Users\jpcar\OneDrive\Documents\STK 11 (x64)\ExampleFiniteMnvrs\Outputs
...
<VAR name = "STK_RF_Environment">
    <SCOPE Class = "RFEnvironment">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 9 Jul 2019 16:00:00.000000000
                EndTime		 10 Jul 2019 16:00:00.000000000
                CurrentTime		 9 Jul 2019 16:00:00.000000000
                Direction		 Forward
                UpdateDelta		 10
    ...
    BEGIN References
        ...
        END Instance
        Instance Satellite/ProMnvrSat
            Satellite/ProMnvrSat		
        END Instance
        Instance Satellite/ProMnvrSat_ODTK
            Satellite/ProMnvrSat_ODTK		
        END Instance
        Instance Satellite/RetroMnvrSat
            Satellite/RetroMnvrSat		
        END Instance
        Instance Satellite/RetroMnvrSat_ODTK
            Satellite/RetroMnvrSat_ODTK		
        END Instance
    END References
